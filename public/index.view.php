                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="flex items-baseline ml-10 space-x-4">
                                ...
                                <a href="/" class="px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-md hover:bg-gray-700" aria-current="page">Home</a>
                                <a href="/about.php" class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">About</a>
                                <a href="/contact.php" class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Contact</a>
